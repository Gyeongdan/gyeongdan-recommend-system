...
print(recommendService.get_top_n_articles(0, 5))
print(recommendService.similar_items(1))
print(recommendService.items_for_new_user(UserDataInfo(101, 23, 'M'), 5))
recommendService.add_user(UserDataInfo(101, 23, 'M'))
recommendService.add_article_data(ArticleDataInfo(101, 'Politics and Society'))
recommendService.add_interaction_data(InteractionDataInfo(101, 101, 5))